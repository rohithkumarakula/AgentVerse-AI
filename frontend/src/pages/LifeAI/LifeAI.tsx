...
const CHAT_HISTORY_KEY =
  "agentverse-life-chat-history-v2";
...
function LifeAI() {
  ...
  useEffect(() => {
    try {
      ...
      if (error instanceof DOMException && error.name === "AbortError") {
        error = new Error(
          "LifeAI took too long to respond. Please try again with a shorter question."
        );
      }

      console.error(
        "LifeAI history load failed:",
        error
      );
    }
  }, []);
  ...
  async function handleSend(
    ...
    try {
      // LifeAI backend (LifeRequest): { message, history }
        ...
        <div className="composer-area">
          ...
          <div className="composer">
            ...
            <input
              ...
              disabled={loading}
              placeholder="Ask LifeAI anything about your goals and habits..."
            />
