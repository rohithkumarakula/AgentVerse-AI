...
const CHAT_HISTORY_KEY =
  "agentverse-tailor-chat-history-v2";
  ...
  useEffect(() => {
    try {
      ...
      if (error instanceof DOMException && error.name === "AbortError") {
        error = new Error(
          "TailorAI took too long to respond. Please try again with a shorter question."
        );
      }

      console.error(
        "TailorAI history load failed:",
        error
      );
    }
  }, []);
  ...
  function getCareerProfile():
    ...
    try {
      ...
      const profile:
        ...
        timeline:
          typeof parsed.timeline ===
            "string"
            ? parsed.timeline.trim()
            : "",

        salaryGoal:
          typeof parsed.salaryGoal ===
            "string"
