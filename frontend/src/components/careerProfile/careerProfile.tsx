...
import { saveCareerProfile } from "../../services/api";
...
function CareerProfile() {
  const [profile, setProfile] = useState<CareerProfileData>(() => {
    const saved = localStorage.getItem("agentverse-career-profile");
    ...
    try {
      ...
      localStorage.removeItem("agentverse-career-profile");
      return emptyProfile;
    }
  });
  ...
  async function handleSave() {
    try {
      ...
      console.error("Career profile save failed:", error);
  ...
  return (
    <div className="career-profile">
      <div className="career-profile-header">
        ...
        <p>
          Tell TailorAI about your career goals.
        </p>
      </div>
      ...
      <div className="career-profile-form">
        ...
        <div className="profile-field">
          ...
          <input
            ...
            onChange={(e) =>
              handleChange("salaryGoal", e.target.value)
            }
          />
        </div>
